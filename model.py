...
# Архитектура полносверточной нейронной сети
def vgg16_encoder_unet(input_shape=(256, 256, 3), weights='imagenet'):
    ...
    block9_conv3 = Conv2D(1, 1, activation='sigmoid')(block9_conv2)
